...
local Tabs = {
    ...
    Fishing = Window:AddTab({Title = "Tab Fishing", Icon = ""}),
    Melee = Window:AddTab({Title = "Tab Fighting Style", Icon = ""}),
    Quests = Window:AddTab({Title = "Tab Quests", Icon = ""}),
    SeaEvent = Window:AddTab({Title = "Tab Sea Events", Icon = ""}),
    Mirage = Window:AddTab({Title = "Tab Race V4", Icon = ""}),
    Drago = Window:AddTab({Title = "Tab Dragon Dojo", Icon = ""}),
...
Tabs.Home:AddButton({
    ...
    Description = "",
    Callback = function()
        setclipboard("https://discord.gg/peGmNEVYxE")
    end
})
...
Tabs.Main:AddSection("Others / Quest")
...
Tabs.Main:AddSection("Others / Mastery")
...
local Q = Tabs.Main:AddToggle("Q", {Title = "Auto Cake Prince [BETA]", Description = "cày hoàng tử bột", Default = false})
Q:OnChanged(function(Value)
...
Tabs.Misc:AddButton({Title = "Rain Fruits", Description = "",Callback = function()
...
iceWalk = Tabs.Misc:AddToggle("iceWalk", {Title = "Turn on Ice Walk", Description = "Đi trên nước nhưng có hiệu ứng trái băng", Default = false})
