-- ✅ MẪU CHUẨN CHO NGƯỜI MỚI | TAI_UCM VIP PRO🤑
...
ImageButton.Image = "http://www.roblox.com/asset/?id=140248847646508"  -- 👈 đổi ID ảnh nút mở menu tại đây (ảnh roblox)
...
Tabs.Main0:AddButton({
	...
	Description = "lồn",
	Callback = function()
		setclipboard("linhđep zai hub")     -- 👈 link khác
	end
})
...
Tabs.Main1:AddButton({
	Title = "TAI_UCM VIP PRO🤑",                             -- 👈 tên nút hiển thị
	Description = "script này ngon á đủ chức năng cả ó😃",-- 👈 mô tả
	Callback = function()
		local Settings = {
